...
class Speckle_analyzer:
    ...
    def plot_report(self):
        ...
        ax3.axhline(y=y_value, color='red', alpha=0.3, linestyle='--', label='Horizontal Cut')
        x_value = toshow.shape[1] // 2
        ax3.axvline(x=x_value, color='blue', alpha=0.3, linestyle='--', label='Vertical Cut')
...
class HDF5ImageViewer(QMainWindow):
    ...
    def load_config(self):
        ...
        if not os.path.exists(self.config_file):
            ...
            try:
                with open(self.config_file, 'w') as f:
                    json.dump({self.username: {'last_dir': '/gdata/dm/9IDD/'}}, f, indent=2)
            except Exception as e:
        ...
        try:
            ...
            if self.username in all_configs:
                ...
                self.config = {'last_dir': '/gdata/dm/9IDD/'}
    ...
    def plot_motor_positions(self):
        ...
        if cluster_match:
            ...
            cluster_number = None
            print("Main file detected (no cluster number)")
        ...
        self.status_label.setText("Motor position plots displayed")
    ...
    def _generate_motor_position_plots(self, x_positions, y_positions, 
        ...
        try:
            ...
            for col, metric in enumerate(metrics):
                ...
                if len(data) >= 4:
                    try:
                        ...
                        axes[1, col].contour(XI, YI, ZI, levels=10, colors='white', 
            ...
            print("Motor position plots displayed")
