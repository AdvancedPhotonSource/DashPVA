...
class DockWindow(QMainWindow):
    ...
    def __init__(self, main_window, title: str = None, width: int = 1000, height: int = 700):
        ...
        self.btn_get_2d_docks.setObjectName("btn_get_2d_docks")
        self.btn_get_3d_docks.setObjectName("btn_get_3d_docks")
        ...
        self.btn_send_2d_docks.setObjectName("btn_send_2d_docks")
        self.btn_send_3d_docks.setObjectName("btn_send_3d_docks")
