...
class ScanMonitorWindow(QMainWindow, LogMixin):
    ...
    def __init__(self, channel: str = ""):
        ...
        uic.loadUi(ui_path("scan_view.ui"), self)
    ...
    def _on_apply_clicked(self) -> None:
        ...
        try:
            ...
            self.signal_start_monitor.connect(self.reader.start_metadata_ca_monitor, Qt.QueuedConnection)
    ...
    def _update_button_states(self):
        if hasattr(self, 'btn_start_scan'):
            self.btn_start_scan.setEnabled(not self.scan_state)
        if hasattr(self, 'btn_stop_scan'):
            self.btn_stop_scan.setEnabled(self.scan_state)
