...
axis_records = {
    ...
    "19IDRobot:Last_Position_Yaw": {
        "AxisNumber": 1,
        "SpecMotorName": "Nu",
        "DirectionAxis": "z+",
        "Position": 0.0,
    },
    "19IDRobot:Last_Position_Pitch": {
        "AxisNumber": 2,
        "SpecMotorName": "Delta",
        "DirectionAxis": "y-",
        "Position": 0.0,
...
def main() -> None:
    ...
    all_records = {
        **axis_records,
        "19ID:UB_matrix": ub_matrix_record,
        "19idDCM:SM3.RBV": energy_record,
    ...
    dynamic_records = {**axis_records, '19idDCM:SM3.RBV':20.0,} #'6idb:spec:UB_matrix': caget('6idb:spec:UB_matrix')}
