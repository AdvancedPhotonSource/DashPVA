...
def main() -> None:
    ...
    all_records = {
        **axis_records,
        **eta,
        "4id:UB_matrix": ub_matrix_record,
        "4idVDCM:BraggEAO.VAL": energy_record,
    ...
    # static_records = {
    #     "4id:UB_matrix": {**ub_matrix_record, "Name": "4id:UB_matrix"},
    #     "4idVDCM:BraggEAO.VAL": {**energy_record, "Name": "4idVDCM:BraggEAO.VAL"},
    ...
    dynamic_records = {**axis_records, '4idVDCM:BraggEAO.VAL':13.0,} #'6idb:spec:UB_matrix': caget('6idb:spec:UB_matrix')}
    ...
    try:
        while True:
            for name, rec in dynamic_records.items():
                ...
                elif name == '4idVDCM:BraggEAO.VAL':
